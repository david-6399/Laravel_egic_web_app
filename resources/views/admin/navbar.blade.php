        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown border-left">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                    ...
                    <h6 class="p-2 mb-0">Notifications</h6>
                                ...
                                <a class="dropdown-item preview-item p-3" >
                                    <div class="preview-thumbnail">
                                        <div class="preview-icon rounded-circle">
                                            <img src="{{asset('admin/assets/images/male avatar.png')}}" alt="">
                                        </div>
                                    </div>
                                    <div class="preview-item-content">
                                        <p class="preview-subject mb-1">Name : {{$userinfo->name}} - ID : {{$userinfo->id}}</p>
                                        <p class="text-muted ellipsis mb-0"> This user want to be studient</p>
                                    </div>
                                </a>
                            </div>
                            @endif
                    @empty
                        <p class="preview-subject mb-1">Aucun Notification</p>
                    @endforelse
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                    <div class="navbar-profile">
                        ...
                        <p id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                    ...
                    <a class="dropdown-item preview-item">
                        ...
                        <div class="preview-item-content">
                            <p class="preview-subject mb-1"><a class="dropdown-item" href="{{ route('logout') }}"
